...
Instructions:
0) Check the examples under examples/avsp2011
1) create the file papers.tex with an \includepaper command for each paper you
...
4) run make (tested on Linux), this will create two PDF files, one for printing
